...
const contractABI = require("../artifacts/contracts/Etherscannode.sol/Etherscannode.json").abi;

program
    .name("etherscannode-cli")
    .description("CLI tool for Etherscannode smart contract")
    .version("1.0.0");
